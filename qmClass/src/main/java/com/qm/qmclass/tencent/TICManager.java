...
/////////////////////////////////////////////////////////////////////////////////
    ...
    public abstract void joinGroup(final Integer groupId, final TICCallback callback);

    public abstract void quitGroup(final Integer groupId, final TICCallback callback);
    //初始化白板和进去trtc房间
    public abstract void initBoardAndTRTC(final TICClassroomOption option, final TICCallback callback);
    //销毁白板和进去trtc房间
    public abstract void uninitBoardAndTRTC(boolean clearBoard);
