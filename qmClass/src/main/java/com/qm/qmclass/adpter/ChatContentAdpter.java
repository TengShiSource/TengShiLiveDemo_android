...
public class ChatContentAdpter extends ArrayAdapter {
    public ChatContentAdpter(Context context, int resource,List<String> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.chat_content_item, parent, false);
        }
