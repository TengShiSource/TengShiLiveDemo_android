...
public class PermissionUtils {
    ...
    public void chekPermissions(Activity context, String[] permissions, @NonNull IPermissionsResult permissionsResult) {
        ...
        if (mPermissionList.size() > 0) {//有权限没有通过，需要申请
            requestPermissions(context, permissions, mRequestCode);
        } else {
    ...
    public void fragmentChekPermissions(Activity context, Fragment fragment,String[] permissions, @NonNull IPermissionsResult permissionsResult) {
        mPermissionsResult = permissionsResult;
